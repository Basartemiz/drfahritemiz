  ...
  'kurtaj': {
    tr: {
      ...
      longDescription: [
        ...
        'Neden Op. Dr. Fahri Temiz? 25 yılı aşkın deneyime sahip Op. Dr. Fahri Temiz, İzmir Buca\'da güvenli ve gizli kürtaj hizmeti sunmaktadır. Modern ve steril muayenehane ortamı, hasta mahremiyetine maksimum özen, güncel tıbbi protokollerin uygulanması, kapsamlı işlem öncesi ve sonrası bakım, psikolojik destek ve aile planlaması danışmanlığı ile hastalarımıza en iyi hizmeti vermekteyiz. İzmir, Buca, Konak, Karabağlar, Gaziemir, Bornova ve çevre ilçelerden gelen hastalarımıza 7/24 ulaşılabilirlik sağlamaktayız.',
      ],
      benefits: [
    ...
    en: {
      ...
      longDescription: [
        ...
        'Why Choose Op. Dr. Fahri Temiz? With over 25 years of experience, Op. Dr. Fahri Temiz provides safe and confidential abortion services in Izmir Buca. We provide the best service to our patients with modern and sterile clinic environment, maximum attention to patient privacy, application of up-to-date medical protocols, comprehensive pre and post-procedure care, psychological support and family planning counseling. We provide 24/7 accessibility for patients coming from Izmir, Buca, Konak, Karabaglar, Gaziemir, Bornova and surrounding districts.',
      ],
      benefits: [
